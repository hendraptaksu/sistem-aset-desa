...
## 2. Kontrak data (JANGAN diubah sepihak, ini dipakai Agent B juga)
```ts
// Akun Kas (dompet): 1000,1010,1014,1015,1016,1017,1018,1028,1029
// Kategori: 4001-4008 (pendapatan), 5002-5007 (beban), 2050 (hutang), 3000 (modal)
...
type PanjarItem = { panjar_id:string; kategori_baga:string /*5002-5007*/; nominal:number };
...
- `src/db/schema.*`, `src/db/migrations/*`, `src/db/seed-coa.ts` (seed persis PRD §2; pisah grup 1xxx vs akun 1000=Kas Tunai)
